...
@app.route('/')
def index():
    # Beispiel-Daten für das Leaderboard
    leaderboard = [
        {"name": "Player1", "mmr": 2000, "rank": "Champion III"},
        {"name": "Player2", "mmr": 1800, "rank": "Champion II"},
        {"name": "Player3", "mmr": 1500, "rank": "Platin I"}
    ]
    player_stats = {"name": "Current Player", "mmr": 1200, "rank": "Gold II"}
